...
public final class Constants {
    ...
    public static final String SYMBOL_ETHEREUM = "ETHUSD";
    public static final String SYMBOL_DOGECOIN = "DOGEUSD";
    public static final String SYMBOL_BINANCECOIN = "BNBUSD";
    ...
    public static final String LIMIT_750 = "750";
    public static final String LIMIT_500 = "500";
    public static final String LIMIT_250 = "250";
    public static final String LIMIT_100 = "100";
    public static final String LIMIT_50 = "50";
    public static final String LIMIT_25 = "25";
